...
//         <h2 className='popup__title'>{props.title}</h2>
// И теперь Вам не нужно дублировать верстку обе ртки попапа, навешивать обработчики оверлея, крестиков и Escape где-то еще. Все будет в одном компоненте Popup. Кстати, можете попробовать сделать компонент Form для любых форм, а так же Input для инпутов.